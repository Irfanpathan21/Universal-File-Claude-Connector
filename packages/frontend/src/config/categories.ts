...
export const CATEGORIES_CONFIG: Record<string, CategoryTheme> = {
  ...
  presentation: {
    ...
    description: 'Convert PPTX to PDF, extract text, images, notes, and inspect slide content',
    ...
    featuredTools: ['pptx_to_pdf', 'extract_pptx_text', 'extract_pptx_images', 'pptx_to_html', 'read_pptx_metadata', 'extract_pptx_notes'],
  },
  video: {
    id: 'video',
    name: 'Video & Audio',
  ...
  ocr: {
    ...
    featuredTools: ['extract_text_from_image_ocr', 'summarize_text', 'extract_keywords', 'sentiment_analysis'],
  },
  ai: {
    id: 'ai',
    name: 'OCR & AI',
  ...
  text: {
    ...
    name: 'Data & Text',
    shortName: 'Data',
    description: 'Text formatting, cleaning, line sorting, and word counters',
    iconName: 'FileText',
    accentColor: '#4C51BF',
    badgeBg: 'bg-indigo-500/10 dark:bg-indigo-500/20',
    badgeText: 'text-indigo-600 dark:text-indigo-400 border-indigo-200 dark:border-indigo-800/40',
  ...
  archive: {
    id: 'archive',
    name: 'Extra Tools',
    shortName: 'Extra Tools',
    description: 'Archive compression, extraction, and utility tools',
    iconName: 'Archive',
    accentColor: '#4A5568',
    badgeBg: 'bg-slate-500/10 dark:bg-slate-500/20',
    badgeText: 'text-slate-700 dark:text-slate-300 border-slate-300 dark:border-slate-700/60',
    themeGradient: 'from-slate-700 to-zinc-800',
    borderHover: 'hover:border-slate-500/50 hover:shadow-slate-500/10',
    headerHoverBg: 'hover:bg-slate-50 dark:hover:bg-slate-950/30 text-slate-700 dark:text-slate-300',
    featuredTools: ['create_zip', 'extract_zip', 'list_archive_contents', 'compress_gzip', 'decompress_gzip'],
  },
  extra: {
    id: 'extra',
    name: 'Extra Tools',
  ...
  metadata: {
    ...
    shortName: 'Security',
    description: 'Inspect metadata, compute cryptographic hashes, and verify checksums',
    iconName: 'Shield',
    accentColor: '#38B2AC',
    badgeBg: 'bg-teal-500/10 dark:bg-teal-500/20',
    badgeText: 'text-teal-600 dark:text-teal-400 border-teal-200 dark:border-teal-800/40',
    themeGradient: 'from-teal-600 to-cyan-600',
    borderHover: 'hover:border-teal-500/50 hover:shadow-teal-500/10',
    headerHoverBg: 'hover:bg-teal-50 dark:hover:bg-teal-950/30 text-teal-600 dark:text-teal-400',
    featuredTools: [],
  },
};
